    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] py-12 text-center">
          <User className="mx-auto h-12 w-12 text-white/30" />
          <h3 className="mt-4 text-lg font-medium text-white">No hay pacientes</h3>
        ...
        <div className="flex items-center justify-between border-t border-white/[0.06] pt-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={page === 1}
              className="rounded-2xl border border-white/[0.08] p-2 hover:bg-white/[0.02] disabled:cursor-not-allowed disabled:opacity-50"
            >
