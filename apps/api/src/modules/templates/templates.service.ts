    ...
    const defaultTemplates: CreateTemplateDto[] = [
      {
        ...
        aiPrompt:
          'Estructura la consulta en formato SOAP. Identifica síntomas, signos vitales anormales, y sugiere diagnósticos diferenciales basados en la información proporcionada.',
      },
      {
        ...
        schema: [
          ...
          {
            name: 'sintomas',
            label: 'Síntomas reportados por padres',
            type: 'textarea',
            required: true,
            section: 'Subjetivo',
          },
          {
            ...
            label: 'Alimentación',
            type: 'select',
            options: ['Lactancia materna', 'Fórmula', 'Mixta', 'Alimentación complementaria'],
            required: false,
            section: 'Subjetivo',
          },
          {
        ...
        aiPrompt:
          'Estructura la consulta pediátrica en formato SOAP. Evalúa el crecimiento y desarrollo según percentiles. Identifica banderas rojas de desarrollo.',
      },
    ];
